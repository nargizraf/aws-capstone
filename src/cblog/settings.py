...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/nargiz/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/nargiz/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.crqckckycg2i.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'nargiz-capstone' # please enter your s3 bucket name
